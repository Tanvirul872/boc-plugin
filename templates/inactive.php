...
$results = $wpdb->get_results("SELECT * FROM $table_name WHERE status = 2 LIMIT $items_per_page OFFSET $offset");
...
$total_pages = ceil($wpdb->get_var("SELECT COUNT(*) FROM $table_name WHERE status = 2") / $items_per_page);
